...
|------------|-------------|--------|-------|
| K-class | ~10 worlds | ~4-6 | Still too dense |
...
M-class uses Half Dice (d3) because red dwarfs have particularly low mass available for planet formation. K-class uses aggressive Dis+3 on standard dice.

### Recommendation for 2026 Book

Update REF-007 to v1.2. Add "Half Dice" term to glossary: rolling d3 (1-3) instead of d6 (1-6), used for M-class stars.
