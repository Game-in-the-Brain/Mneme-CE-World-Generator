...
| QA-069 | ✅ Fixed | Wealth/Development contradiction in narrative text | 6 |
| QA-070 | ✅ Fixed | Mining habitat starport floor | 6 |
| QA-071 | 📋 Queued | Mainworld "raison d'être" narrative generator | 6 |
| QA-072 | ✅ Fixed | Sector Dynamics discoverability UX | 6 |
...
| R3 | Population-scaled government terminology (<1M → tribal/org terms) | ✅ Fixed — QA-073 shipped with full POWER_STRUCTURE + CULTURE_TRAIT low-pop variants |
