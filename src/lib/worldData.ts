...
export const TL_TABLE: Record<number, TLEntry> = {
  ...
  13: { mtl: 13, ceTL: 9.5, ceYear: '2400 CE', heYear: '12,400 HE', eraName: 'Outer System Development',                        keyTechnologies: 'World Serpents and jump gates connect star systems — near-instantaneous travel. Great Trees (space elevators) and Celestials (solar swarms) terraform worlds. Colony ships — O\'Neill cylinders and spiral CNT constructs — jump to new stars. Migrant swarms of millions. Earth restoration begins.' },
  14: { mtl: 14, ceTL: 10.0, ceYear: '2500 CE', heYear: '12,500 HE', eraName: 'Early Interstellar Trade & Exploration',         keyTechnologies: 'Jump opens nearby systems. First contact with Divergent Humans — who used early FTL to colonise other stars independently. Convergent technology exchange begins. Terraforming increases Venus and Mars habitability. Intense population exodus from Sol system.' },
  15: { mtl: 15, ceTL: 10.5, ceYear: '2600 CE', heYear: '12,600 HE', eraName: 'Interstellar Colonisation',                      keyTechnologies: 'Interstellar colonisation well underway with 100 billion+ people outside Sol. Self-directed Spiral Ships generated by the giants — especially Jupiter, which keeps growing.' },
