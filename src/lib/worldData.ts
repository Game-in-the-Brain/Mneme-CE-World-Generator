...
export const TL_TABLE: Record<number, TLEntry> = {
  ...
  13: { mtl: 13, ceTL: 9.5, ceYear: '2400 CE', heYear: '12,400 HE', eraName: 'Outer System Development',                        keyTechnologies: 'World Serpents (particle accelerators on radiation belts) and jump gates connect star systems. Great Trees (fixed space elevators) and Celestials (inner system solar swarms sailing light) terraform worlds. Colony ships — O\'Neill cylinders and spiral CNT constructs — jump to new stars. Migrant swarms of millions. Earth restoration begins.' },
